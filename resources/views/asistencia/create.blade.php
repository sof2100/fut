...
<div class="col-xs-12 col-sm-12 col-md-12 form">
  ...
  <form class="form-horizontal" action="/asistencia" class="was-validated" method="POST" >
    @csrf
    <!-- nombre -->
    ...
    <div class="form-group col-xs-12 col-sm-6 col-md-6 form">
      <label class="control-label col-xs-12 col-sm-4 col-md-4" >asistencias:</label>
      <div class="col-xs-12 col-sm-8 col-md-8">
        <input name="asistencias" type='number'>
      </div>
    </div>
</div>
